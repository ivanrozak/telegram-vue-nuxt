    ...
    <div class="col-span-3">
      <div class="w-full h-screen border-r border-secondary relative">
        <div class="h-20 flex items-center justify-between px-6">
          ...
          <div v-if="menuVisible" class="absolute right-0 top-0 mr-6 mt-16  rounded-xl rounded-tr-sm shadow-sm bg-primary focus:outline-none" >
            <div class="py-1" role="none">
              <a href="#" class="text-white block px-4 py-2 text-sm" role="menuitem" tabindex="-1" >Account settings</a>
            </div>
          </div>
        </div>
        <div class="h-14 px-6 flex items-center justify-between">
          <input class="bg-grey w-full mr-5 py-2 px-4 rounded-xl focus:border-white" type="text" placeholder="Type your message">
          <button class="active:scale-90" >
            <IconPlus :fill="color.primary"/>
          </button>
        </div>
        <div class="h-14 flex items-center justify-center space-x-4">
          <button class="bg-grey py-2 px-4 font-semibold rounded-lg">All</button>
          <button class="bg-primary text-white py-2 px-4 font-semibold rounded-lg">Important</button>
          <button class="bg-grey py-2 px-4 font-semibold rounded-lg">Unread</button>
        </div>
          ...
          <div class="flex items-center px-6 hover:bg-grey cursor-pointer py-4">
            ...
            <div class="flex justify-between w-full">
              ...
              <div class="text-right">
                ...
                <div class="w-5 h-5 bg-primary rounded-full text-white flex items-center justify-center text-xs font-semibold ml-auto">1</div>
              </div>
            </div>
      ...
      <div class="h-screen w-full flex flex-col justify-between">
        ...
        <div class="bg-grey h-full overflow-y-auto px-8 py-4">
          <div class="flex space-x-3 items-end">
            ...
            <div class="bg-primary rounded-xl rounded-bl-sm px-4 py-2 max-w-[40%]">
              <p class="text-white text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque, vel.</p>
            </div>
          </div><div class="flex justify-end space-x-3 items-end">
            <div class="bg-primary rounded-xl rounded-br-sm px-4 py-2 max-w-[40%]">
              <p class="text-white text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque, vel.</p>
            </div>
            <img class="h-12 w-12 rounded-2xl" src="images/User.png" alt="">
        </div>
        ...
        <div class="bg-white h-28 px-8 py-5">
          <div class="w-full h-full bg-grey flex space-x-5 justify-between items-center rounded-xl px-4">
...
export default {
  components: {IconSearch, IconProfile, IconPlus, IconEmoticon, IconDCheck, IconBack, IconMenu, IconSend},
  layout: 'default',
  data() {
    return {
      color : {
